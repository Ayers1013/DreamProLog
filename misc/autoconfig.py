...
class ConfigurationNode:
    ...
    def __getattr__(self, name):
        if GET_PARAMETER_BY_ATTR: return self[name]
    ...
    def configure(self, ctor, *args, config_name=None, unique_name=None, **kwargs):
        ...
        if issubclass(ctor, ConfiguredModule):
            ...
            for k in signature.parameters[len(args):]:
...
class ConfiguredModule(ConfigurationNode):
    ...
    def __init__(self, *args, parent=None, config_name=None, unique_name=None, params=None, **kwargs):
        if params is None:
            params = {}
        params.update(kwargs)
        ConfigurationNode.__init__(self, parent, config_name, unique_name, params)
